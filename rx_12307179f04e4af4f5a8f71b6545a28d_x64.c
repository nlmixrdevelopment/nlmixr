...
extern void rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_ptr();



// prj-specific differential eqns
void rx_12307179f04e4af4f5a8f71b6545a28d_x64_dydt(unsigned int _neq, double t, double *__zzStateVar__, double *__DDtStateVar__)
{
double 
		depot,
	_ETA_1_,
	...
	__DDtStateVar__[2]=_InfusionRate(2)+-depot*exp(_ETA_1_+_THETA_1_)-rx__sens_depot_BY_ETA_1___*exp(_ETA_1_+_THETA_1_);
	__DDtStateVar__[3]=_InfusionRate(3)+-rx__sens_depot_BY_ETA_2___*exp(_ETA_1_+_THETA_1_);
	__DDtStateVar__[4]=_InfusionRate(4)+-rx__sens_depot_BY_ETA_3___*exp(_ETA_1_+_THETA_1_);
	__DDtStateVar__[5]=_InfusionRate(5)+depot*exp(_ETA_1_+_THETA_1_)-rx__sens_center_BY_ETA_1___*exp(_ETA_2_+_THETA_2_)*exp(-_ETA_3_-_THETA_3_)+rx__sens_depot_BY_ETA_1___*exp(_ETA_1_+_THETA_1_);
	__DDtStateVar__[6]=_InfusionRate(6)+-center*exp(_ETA_2_+_THETA_2_)*exp(-_ETA_3_-_THETA_3_)-rx__sens_center_BY_ETA_2___*exp(_ETA_2_+_THETA_2_)*exp(-_ETA_3_-_THETA_3_)+rx__sens_depot_BY_ETA_2___*exp(_ETA_1_+_THETA_1_);
	__DDtStateVar__[7]=_InfusionRate(7)+center*exp(_ETA_2_+_THETA_2_)*exp(-_ETA_3_-_THETA_3_)-rx__sens_center_BY_ETA_3___*exp(_ETA_2_+_THETA_2_)*exp(-_ETA_3_-_THETA_3_)+rx__sens_depot_BY_ETA_3___*exp(_ETA_1_+_THETA_1_);
	rx_pred_=center*exp(-_ETA_3_-_THETA_3_);
	rx__sens_rx_pred__BY_ETA_1___=rx__sens_center_BY_ETA_1___*exp(-_ETA_3_-_THETA_3_);
	rx__sens_rx_pred__BY_ETA_2___=rx__sens_center_BY_ETA_2___*exp(-_ETA_3_-_THETA_3_);
	rx__sens_rx_pred__BY_ETA_3___=-center*exp(-_ETA_3_-_THETA_3_)+rx__sens_center_BY_ETA_3___*exp(-_ETA_3_-_THETA_3_);
...
void rx_12307179f04e4af4f5a8f71b6545a28d_x64_calc_jac(unsigned int _neq, double t, double *__zzStateVar__, double *__PDStateVar__, unsigned int __NROWPD__) {
  _jac_counter_inc();
}
// Functional based initial conditions.
void rx_12307179f04e4af4f5a8f71b6545a28d_x64_inis(SEXP _ini_sexp){
...
void rx_12307179f04e4af4f5a8f71b6545a28d_x64_calc_lhs(double t, double *__zzStateVar__, double *_lhs) {
double 
		__DDtStateVar_0__,
	__DDtStateVar_1__,
	__DDtStateVar_2__,
	...
	__DDtStateVar_2__=_InfusionRate(2)+-depot*exp(_ETA_1_+_THETA_1_)-rx__sens_depot_BY_ETA_1___*exp(_ETA_1_+_THETA_1_);
	__DDtStateVar_3__=_InfusionRate(3)+-rx__sens_depot_BY_ETA_2___*exp(_ETA_1_+_THETA_1_);
	__DDtStateVar_4__=_InfusionRate(4)+-rx__sens_depot_BY_ETA_3___*exp(_ETA_1_+_THETA_1_);
	__DDtStateVar_5__=_InfusionRate(5)+depot*exp(_ETA_1_+_THETA_1_)-rx__sens_center_BY_ETA_1___*exp(_ETA_2_+_THETA_2_)*exp(-_ETA_3_-_THETA_3_)+rx__sens_depot_BY_ETA_1___*exp(_ETA_1_+_THETA_1_);
	__DDtStateVar_6__=_InfusionRate(6)+-center*exp(_ETA_2_+_THETA_2_)*exp(-_ETA_3_-_THETA_3_)-rx__sens_center_BY_ETA_2___*exp(_ETA_2_+_THETA_2_)*exp(-_ETA_3_-_THETA_3_)+rx__sens_depot_BY_ETA_2___*exp(_ETA_1_+_THETA_1_);
	__DDtStateVar_7__=_InfusionRate(7)+center*exp(_ETA_2_+_THETA_2_)*exp(-_ETA_3_-_THETA_3_)-rx__sens_center_BY_ETA_3___*exp(_ETA_2_+_THETA_2_)*exp(-_ETA_3_-_THETA_3_)+rx__sens_depot_BY_ETA_3___*exp(_ETA_1_+_THETA_1_);
	rx_pred_=center*exp(-_ETA_3_-_THETA_3_);
	rx__sens_rx_pred__BY_ETA_1___=rx__sens_center_BY_ETA_1___*exp(-_ETA_3_-_THETA_3_);
	rx__sens_rx_pred__BY_ETA_2___=rx__sens_center_BY_ETA_2___*exp(-_ETA_3_-_THETA_3_);
	rx__sens_rx_pred__BY_ETA_3___=-center*exp(-_ETA_3_-_THETA_3_)+rx__sens_center_BY_ETA_3___*exp(-_ETA_3_-_THETA_3_);
...
extern SEXP rx_12307179f04e4af4f5a8f71b6545a28d_x64_model_vars(){
	...
	SET_STRING_ELT(mmd5,0,mkChar("2eb168b8cf4d3e2ab164244168841b49"));
	SET_STRING_ELT(mmd5n,1,mkChar("parsed_md5"));
	SET_STRING_ELT(mmd5,1,mkChar("12307179f04e4af4f5a8f71b6545a28d"));
	SET_STRING_ELT(trann,0,mkChar("jac"));
	SET_STRING_ELT(tran,0,mkChar("fullint"));
	SET_STRING_ELT(trann,1,mkChar("prefix"));
	SET_STRING_ELT(tran, 1,mkChar("rx_12307179f04e4af4f5a8f71b6545a28d_x64_"));
	SET_STRING_ELT(trann,2,mkChar("dydt"));
	SET_STRING_ELT(tran, 2,mkChar("rx_12307179f04e4af4f5a8f71b6545a28d_x64_dydt"));
	SET_STRING_ELT(trann,3,mkChar("calc_jac"));
	SET_STRING_ELT(tran, 3,mkChar("rx_12307179f04e4af4f5a8f71b6545a28d_x64_calc_jac"));
	SET_STRING_ELT(trann,4,mkChar("calc_lhs"));
	SET_STRING_ELT(tran, 4,mkChar("rx_12307179f04e4af4f5a8f71b6545a28d_x64_calc_lhs"));
	SET_STRING_ELT(trann,5,mkChar("model_vars"));
	SET_STRING_ELT(tran, 5,mkChar("rx_12307179f04e4af4f5a8f71b6545a28d_x64_model_vars"));
	SET_STRING_ELT(trann,6,mkChar("ode_solver"));
	SET_STRING_ELT(tran, 6,mkChar("rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver"));
	SET_STRING_ELT(trann,7,mkChar("ode_solver_sexp"));
	SET_STRING_ELT(tran, 7,mkChar("rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_sexp"));
	SET_STRING_ELT(trann,8,mkChar("ode_solver_0_6"));
	SET_STRING_ELT(tran, 8,mkChar("rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_0_6"));
	SET_STRING_ELT(trann,9,mkChar("ode_solver_focei_eta"));
	SET_STRING_ELT(tran, 9,mkChar("rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_focei_eta"));
	SET_STRING_ELT(trann,10,mkChar("ode_solver_ptr"));
	SET_STRING_ELT(tran, 10,mkChar("rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_ptr"));
	SET_STRING_ELT(trann,11,mkChar("inis"));
	SET_STRING_ELT(tran, 11,mkChar("rx_12307179f04e4af4f5a8f71b6545a28d_x64_inis"));
...
extern void rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver(
                    int *neq,
                    double *theta,      //order:
                    double *time,
                    int *evid,
  ...
  rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_ptr();
  _old_c(neq, theta, time, evid, ntime, inits, dose, ret, atol, rtol, stiff, transit_abs, nlhs, lhs, rc);
}

void rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_0_6(int *neq,
                        double *theta,  //order:
                        double *time,
                        int *evid,
                        int *ntime,
...
extern void rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_ptr  (){
  _assign_fn_pointers(rx_12307179f04e4af4f5a8f71b6545a28d_x64_dydt , rx_12307179f04e4af4f5a8f71b6545a28d_x64_calc_lhs , rx_12307179f04e4af4f5a8f71b6545a28d_x64_calc_jac, rx_12307179f04e4af4f5a8f71b6545a28d_x64_inis, 2 , 22,
#ifdef __DEBUG__
                      1
#else
                      0
...
extern SEXP rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_sexp (// Parameters
                                 SEXP sexp_theta,
                                 SEXP sexp_inits,
                                 SEXP sexp_lhs,
				 // Events
...
static R_NativePrimitiveArgType rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solverrx_t[] = {
...
static R_NativePrimitiveArgType  rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_0_6rx_t[] = {
  //*neq, *theta, *time,  *evid, *ntime, *inits,   *dose,   *ret,     *atol,  *rtol,   *stiff, *transit_abs, *nlhs, *lhs, *rc
...
void R_init_rx_12307179f04e4af4f5a8f71b6545a28d_x64 (DllInfo *info){
  ...
  R_RegisterCCallable("rx_12307179f04e4af4f5a8f71b6545a28d_x64","rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver",       (DL_FUNC) rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver);
  R_RegisterCCallable("rx_12307179f04e4af4f5a8f71b6545a28d_x64","rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_sexp",  (DL_FUNC) rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_sexp);
  R_RegisterCCallable("rx_12307179f04e4af4f5a8f71b6545a28d_x64","rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_0_6",   (DL_FUNC) rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_0_6);
  R_RegisterCCallable("rx_12307179f04e4af4f5a8f71b6545a28d_x64","rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_ptr",   (DL_FUNC) rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_ptr);

  /* R_registerRoutines(info, NULL, NULL, NULL, NULL); */
  /* R_useDynamicSymbols(info,TRUE); */

  static const R_CMethodDef cMethods[] = {
    {"rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver", (DL_FUNC) &rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver, 15, rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solverrx_t},
    {"rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_0_6", (DL_FUNC) &rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_0_6, 21, rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_0_6rx_t},
    {NULL, NULL, 0, NULL}
  };
  
  R_CallMethodDef callMethods[]  = {
    {"rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_ptr", (DL_FUNC) &rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_ptr, 0},
    {"rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_sexp", (DL_FUNC) &rx_12307179f04e4af4f5a8f71b6545a28d_x64_ode_solver_sexp, 23},
    {"rx_12307179f04e4af4f5a8f71b6545a28d_x64_model_vars", (DL_FUNC) &rx_12307179f04e4af4f5a8f71b6545a28d_x64_model_vars, 0},
    {"rx_12307179f04e4af4f5a8f71b6545a28d_x64_inis", (DL_FUNC) &rx_12307179f04e4af4f5a8f71b6545a28d_x64_inis, 1},
    {NULL, NULL, 0}
  };
