...
SEXP _nlmixr_saemDoPred(SEXP, SEXP, SEXP, SEXP, SEXP);
SEXP _nlmixr_saemFit(SEXP, SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
  ...
  {"_nlmixr_saemDoPred", (DL_FUNC) &_nlmixr_saemDoPred, 5},
  {"_nlmixr_saemFit", (DL_FUNC) &_nlmixr_saemFit, 3},
  {NULL, NULL, 0}
};
