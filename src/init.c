...
SEXP _nlmixr_saemDoPred(SEXP, SEXP, SEXP, SEXP);
SEXP _nlmixr_saemFit(SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
  ...
  {"_nlmixr_saemDoPred", (DL_FUNC) &_nlmixr_saemDoPred, 4},
  {"_nlmixr_saemFit", (DL_FUNC) &_nlmixr_saemFit, 2},
  {NULL, NULL, 0}
};
