...
void RxODE_mod_file4b7813735cdf_dydt(unsigned int neq, double t, double *__zzStateVar__, double *__DDtStateVar__)
{
double
	centr,
	K21,
...
void RxODE_mod_file4b7813735cdf_calc_lhs(double t, double *__zzStateVar__, double *lhs) {
double
	centr,
	K21,
	periph,
