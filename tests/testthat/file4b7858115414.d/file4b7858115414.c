...
void RxODE_mod_file4b7858115414_dydt(unsigned int neq, double t, double *__zzStateVar__, double *__DDtStateVar__)
{
double
	abs,
	KA,
...
void RxODE_mod_file4b7858115414_calc_lhs(double t, double *__zzStateVar__, double *lhs) {
double
	abs,
	KA,
	centr,
