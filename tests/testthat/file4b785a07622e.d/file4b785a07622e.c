...
void RxODE_mod_file4b785a07622e_dydt(unsigned int neq, double t, double *__zzStateVar__, double *__DDtStateVar__)
{
double
	centr,
	K21,
...
void RxODE_mod_file4b785a07622e_calc_lhs(double t, double *__zzStateVar__, double *lhs) {
double
	centr,
	K21,
	periph,
