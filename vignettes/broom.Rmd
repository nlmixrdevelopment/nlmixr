...
fit.s <- nlmixr(pheno, pheno_sd, "saem", control=list(logLik=TRUE), table=list(cwres=TRUE, npde=TRUE))
fit.f <- nlmixr(pheno, pheno_sd, "focei", table=list(cwres=TRUE, npde=TRUE))
```
