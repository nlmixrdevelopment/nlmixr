...
```{r}
library(huxtable)
## Since this is for a table output, you will probably want to adjust the separators
## This gives sd: and cor: eta1, eta2
options(broom.mixed.sep1=": ",
        broom.mixed.sep2=", ")

tbl <- huxreg('Phenobarbitol'=fit,
              statistics=c(N = "nobs", "Objective Function" = "OBJF", "logLik", "AIC"))

tbl
```

A word-based table can be easily created with the tool:
```{r}
library(officer)
ft  <- tbl %>%
